...
module.exports = {
  ...
  head: [
    ...
    ['meta', {name: 'description', content: '聪聪碎碎念,记录开发生活,ccoderJava,聪聪,ccoder'}],
  ...
  title: '聪聪碎碎念',
  description: '聪聪碎碎念,记录开发生活,ccoderJava,聪聪,ccoder',
  theme: '@vuepress/blog',
  themeConfig: {
    lastUpdated: "上次更新",
    ...
    logo: './favicon.ico',
    nav: [
      {text: '文章', link: '/', english: "study"},
      {text: '随笔', link: '/notes/', english: "notes"},
      {text: '标签', link: '/tag/', english: "tags"},
      {
        text: '个人简历',
        target: '_blank',
        link: 'https://ccoderjava.github.io/chencong_Java Development Engineer_5 years.pdf'
      },
    ],
    footer: {
      copyright: [
        {
          text: '鄂ICP备2021021487号-1',
