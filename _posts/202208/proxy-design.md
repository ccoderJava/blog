...
![](https://ccoder-markdown-oss.oss-cn-shanghai.aliyuncs.com/md/2022-08-20-104347.jpg)
从上图可以先总结一波：
...
![image.png](https://ccoder-markdown-oss.oss-cn-shanghai.aliyuncs.com/md/2022-08-20-104402.png)
...
![image.png](https://ccoder-markdown-oss.oss-cn-shanghai.aliyuncs.com/md/2022-08-20-104417.png)
这里总共生成了三个字节码文件：
...
其实上面使用动态代理对委托类进行增强处理时，可以感受到与其他设计模式有一些相似支持，对委托类进行装饰处理。在这里就简单总结一下与其他结构型模式之间区别。

### 5.1 代理模式与装饰模式区别

**装饰模式**：在不必改变委托类和继承情况下，动态的扩展委托对象的功能。通过创建一个包装对象来装饰委托类的真实功能。

- 装饰器在于关注点是：在一个对象上动态添加方法。
